...
class CommentActivity : AppCompatActivity() {
    ...
    var destinatationUid : String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        destinatationUid = intent.getStringExtra("destinationUid")
        ...
        comment_btn_send?.setOnClickListener {
            ...
            commentAlarm(destinatationUid!!, comment_edit_message.text.toString())

            comment_edit_message.setText("")
        }
    }

    fun commentAlarm(destinatationUid : String, message : String) {
        var alarmDTO = AlarmDTO()
        alarmDTO.destinationUid = destinatationUid
